    ...
    public class YandexGame : MonoBehaviour
    {
...
#else
            SetAuthorization(@"{""playerAuth""" + ": " + @"""resolved""," + @"""playerName""" + ": " + @"""Ivan"", " + @"""playerId""" + ": " + @"""tOpLpSh7i8QG8Voh/SuPbeS4NKTj1OxATCTKQF92H4c="", " + @"""playerPhoto""" + ": " + @"""https://s00.yaplakal.com/pics/pics_original/1/2/7/4683721.jpg""}");
#endif
        }
        ...
        public static void GetLeaderboard(string nameLB, int maxQuantityPlayers, int quantityTop, int quantityAround, string photoSizeLB)
        {
            ...
            if (_leaderboardEnable)
            {
                ...
                photo[0] = "https://s00.yaplakal.com/pics/pics_original/1/2/7/4683721.jpg";
                photo[1] = "https://s00.yaplakal.com/pics/pics_original/1/2/7/4683721.jpg"; 
                photo[2] = "https://s00.yaplakal.com/pics/pics_original/1/2/7/4683721.jpg";
        ...
        public void PaymentsEntries(string data)
        {
            ...
            PaymentsData.imageURI[0] = "https://s00.yaplakal.com/pics/pics_original/1/2/7/4683721.jpg";
            PaymentsData.imageURI[1] = "https://s00.yaplakal.com/pics/pics_original/1/2/7/4683721.jpg";
            PaymentsData.imageURI[2] = "https://s00.yaplakal.com/pics/pics_original/1/2/7/4683721.jpg";
